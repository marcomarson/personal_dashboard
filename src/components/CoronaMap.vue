...
import * as maps from '@/components/Charts/map';
...
export default {
  ...
  var covid_us_timeline = maps.covid_us_timeline;
  var covid_us_total_timeline = [{'date': '2020-04-02', 'confirmed': 3, 'deaths': 0, 'recovered': 0}, {'date': '2020-04-03', 'confirmed': 0, 'deaths': 0, 'recovered': 0}, {'date': '2020-04-04', 'confirmed': 1, 'deaths': 0, 'recovered': 0}, {'date': '2020-04-05', 'confirmed': 0, 'deaths': 0, 'recovered': 0}, {'date': '2020-04-06', 'confirmed': 3, 'deaths': 0, 'recovered': 0}, {'date': '2020-04-07', 'confirmed': 8, 'deaths': 0, 'recovered': 0}, {'date': '2020-04-08', 'confirmed': 9, 'deaths': 0, 'recovered': 0}]
...
var numberFormatter = new am4core.NumberFormatter();
  ...
  var currentIndex;
  var currentCountry = "Brazil (Total)";
  ...
  console.log("BRAZIL LOW ->"+am4geodata_brazilLow)
    console.log(am4geodata_brazilLow)

  mapChart.geodata = am4geodata_brazilLow;
  ...
  title.text = "COVID-19 Brazil - Hilab";
  title.align = "left";
  ...
  slider.events.on("rangechanged", function(event) {
    ...
    console.log("index changed ->"+covid_us_timeline)
